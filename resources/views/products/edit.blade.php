  ...
  <div class="max-w-3xl mx-auto p-8 bg-white shadow-md rounded-2xl mt-12">
    ...
    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        ...
        <input type="text" id="title" name="title" value="{{ old('title', $product->title) }}" placeholder="e.g., HP Laptop 14-inch" required
...
<div class="mb-6">
  ...
  <input type="checkbox" id="available" name="available" {{ $product->available ? 'checked' : '' }}
